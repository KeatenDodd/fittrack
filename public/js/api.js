...
export const api = {
  ...
  moveExerciseMedia: (tMediaId, tToSeId) => put('/sessions/media/' + tMediaId + '/move', { toSeId: tToSeId }),
  supersetExercise: (tSeId, tWithSeId) => put('/sessions/exercises/' + tSeId + '/superset', { withSeId: tWithSeId }),
  unlinkSuperset: (tSeId) => put('/sessions/exercises/' + tSeId + '/superset', { unlink: true }),
